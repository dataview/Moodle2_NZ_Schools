...
if (!core_tables_exist()) {
    ...
    if (empty($agreelicense)) {
        ...
        echo '<br />';
        $continue = new single_button(new moodle_url('/admin/index.php', array('lang'=>$CFG->lang, 'agreelicense'=>1, 'seenpresetup'=>1)), get_string('continue'), 'get');
    ...
    if (empty($confirmrelease)) {
        ...
        if (!check_moodle_environment($release, $environment_results, true, ENV_SELECT_RELEASE)) {
            ...
            echo $OUTPUT->continue_button(new moodle_url('/admin/index.php', array('agreelicense'=>1, 'confirmrelease'=>1, 'lang'=>$CFG->lang, 'seenpresetup'=>1)));
        }
