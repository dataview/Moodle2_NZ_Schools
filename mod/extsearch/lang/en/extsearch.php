...
/**
 * Strings for component 'extsearch', language 'en', branch 'MOODLE_20_STABLE'
 *
 * @package    mod
...
$string['modulename'] = 'External Search Result';
$string['modulenameplural'] = 'External Search Results';
$string['neverseen'] = 'Never seen';
$string['optionsheader'] = 'Options';
$string['pluginadministration'] = 'External Search module administration';
$string['pluginname'] = 'External search result';
...
$string['extsearch:view'] = 'View External Search Result';
